...
export type Expense = {
  ...
  // on these are locked server-side; only Release/Undo Release on the Commissions page changes them.
  commissionOrderIds: string[] | null
  // Derived by the server from the field above. Drives the "Auto" badge / locked-field treatment
  // in expense-table.tsx and expense-form-dialog.tsx.
