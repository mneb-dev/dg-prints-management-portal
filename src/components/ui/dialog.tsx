...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-5 -mb-5 flex shrink-0 flex-col-reverse gap-2 rounded-b-2xl border-t bg-muted/40 px-5 py-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
...
/** Scrollable middle of a dialog — header and footer stay visible while a long form scrolls. */
