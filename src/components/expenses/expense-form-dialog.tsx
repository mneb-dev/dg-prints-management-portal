...
const AUTO_SOURCE_BANNER: Record<ExpenseAutoSource, string> = {
  commission_release:
    "Auto-generated by a commission release. Amount, category, and date are locked — adjust payment method or notes here, or use Release/Undo Release on the Incentives page for anything else.",
  monthly_incentive_release:
    "Auto-generated by a monthly incentive release. Amount, category, and date are locked — adjust payment method or notes here, or use Release/Undo Release on the Incentives page for anything else.",
}
