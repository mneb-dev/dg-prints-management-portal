...
const AUTO_SOURCE_BANNER: Record<ExpenseAutoSource, string> = {
  commission_release:
    "Auto-generated by a commission release. Amount, category, and date are locked — adjust payment method or notes here, or use Release/Undo Release on the Commissions page for anything else.",
}
