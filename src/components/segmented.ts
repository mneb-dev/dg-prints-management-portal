...
export const SEGMENT_TRACK_CLASS = "flex-nowrap gap-0.5 rounded-lg border border-input bg-muted/60 p-0.5"

export const SEGMENT_CLASS = cn(
  "h-7 gap-2 rounded-md border-0 px-3 text-muted-foreground transition-[background-color,color,box-shadow] duration-200 hover:bg-background/60 hover:text-foreground",
